...
cp.scripts.define(() => {
	// Obtained from: For terms of use, see http://www.unicode.org/terms_of_use.html
	const emojis = [
		["😀", "grinning face"],
		...
		["👪", "family"],
		["👪🏻", "family: light skin tone"],
		["👪🏼", "family: medium-light skin tone"],
		["👪🏽", "family: medium skin tone"],
		["👪🏾", "family: medium-dark skin tone"],
		["👪🏿", "family: dark skin tone"],
